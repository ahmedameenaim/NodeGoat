pipeline {
    ...
    stages {
        ...
        stage('snyk dependency scan') {
          ...
          steps {
             sh "docker run -it -e SNYK_TOKEN=f8764dcb-48ac-473d-bf1d-e05c0a9862e9 -e MONITOR=true -v /var/lib/jenkins/workspace/nodegoat-pipline:/project snyk/snyk-cli:npm test"
          } 
        }
